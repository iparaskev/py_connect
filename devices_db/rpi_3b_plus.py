...
i2c_1 = I2C(sda=pin_3, scl=pin_5)
i2c_2 = I2C(sda=pin_27, scl=pin_28)

spi_1 = SPI(mosi=pin_19, miso=pin_21, sclk=pin_23, ce=[pin_24, pin_26])
spi_2 = SPI(mosi=pin_38, miso=pin_35, sclk=pin_40, ce=[pin_12, pin_11, pin_36])
